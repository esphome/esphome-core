...
class MPU6050Component : public PollingComponent {
 public:
  explicit MPU6050Component(uint8_t address = 0x68, uint32_t update_interval = 15000);
  ...
  void write_register_8_(uint8_t reg, uint8_t value);
