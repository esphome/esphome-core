...
#define ESPHOMELIB_LOG_SECRET_BEGIN  "\033[5m"
#define ESPHOMELIB_LOG_SECRET_END  "\033[6m"
#define LOG_SECRET(x) ESPHOMELIB_LOG_SECRET_BEGIN x ESPHOMELIB_LOG_SECRET_END
