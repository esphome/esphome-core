...
uint32_t UltrasonicSensorComponent::get_timeout_us() const { return this->timeout_us_; }
void UltrasonicSensorComponent::set_timeout_us(uint32_t timeout_us) { this->timeout_us_ = timeout_us; }
void UltrasonicSensorComponent::set_timeout_m(float timeout_m) { this->set_timeout_us(m_to_us(timeout_m)); }
...
float UltrasonicSensorComponent::get_timeout_m() const { return us_to_m(this->get_timeout_us()); }
float UltrasonicSensorComponent::get_setup_priority() const { return setup_priority::HARDWARE_LATE; }
uint32_t UltrasonicSensorComponent::get_pulse_time_us() const { return this->pulse_time_us_; }
