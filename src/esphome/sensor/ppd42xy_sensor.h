...
class Ppd42xSensorComponent : public PollingSensorComponent {
 public:
   ...
   *
   * @param pm_2_5_pin The pm_2_5 pin where the pm_2_5 is listened for.
   ...
   */
  Ppd42x10SensorComponent(const std::string &name, GPIOPin *pm_10_0_pin
                        uint32_t update_interval = 5000);
  Ppd42x02SensorComponent(const std::string &name, GPIOPin *pm_02_5_pin,
                        uint32_t update_interval = 5000);

  /// Set the timeout for waiting for the PIN in µs.
