#ifndef ESPHOME_COMPONENT_H
#define ESPHOME_COMPONENT_H
...
/** The base class for all ESPHome components.
 *
 * ESPHome uses components to separate code for self-contained units such as
