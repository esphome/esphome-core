...
float Servo::get_setup_priority() const {
  return setup_priority::HARDWARE_LATE;
}
void Servo::set_min_level(float min_level) {
  this->min_level_ = min_level;
}
void Servo::set_idle_level(float idle_level) {
  this->idle_level_ = idle_level;
}
void Servo::set_max_level(float max_level) {
