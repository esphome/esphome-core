...
template<typename... Ts>
ToggleAction<Ts...>::ToggleAction(FanState *state) : state_(state) { }
template<typename... Ts>
...
template<typename... Ts>
TurnOnAction<Ts...>::TurnOnAction(FanState *state) : state_(state) { }
template<typename... Ts>
...
template<typename... Ts>
TurnOffAction<Ts...>::TurnOffAction(FanState *state) : state_(state) {
...
template<typename... Ts>
TurnOnAction<Ts...> *FanState::make_turn_on_action() {
  return new TurnOnAction<Ts...>(this);
}
template<typename... Ts>
TurnOffAction<Ts...> *FanState::make_turn_off_action() {
  return new TurnOffAction<Ts...>(this);
}
template<typename... Ts>
ToggleAction<Ts...> *FanState::make_toggle_action() {
  return new ToggleAction<Ts...>(this);
}
