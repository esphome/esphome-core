...
#ifdef USE_MPR121
sensor::MPR121_Sensor *Application::make_mpr121(uint8_t address, uint8_t channels) {
  return this->register_component(new MPR121_Sensor(this->i2c_, address, channels));
}
#endif
