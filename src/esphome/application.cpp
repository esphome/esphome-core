...
#ifdef USE_PPD42X
sensor::PPD42XComponent *Application::make_ppd42x(uint32_t update_interval, sensor::PPD42XType type) {
  return this->register_component(new PPD42XComponent(update_interval, type));
}
#endif
