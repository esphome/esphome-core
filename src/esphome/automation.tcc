...
template<typename... Ts>
void Trigger<Ts...>::set_parent(Automation<Ts...> *parent) {
  this->parent_ = parent;
}
...
template<typename... Ts>
void Automation<Ts...>::stop() {
  this->actions_.stop();
}
template<typename... Ts>
LambdaCondition<Ts...>::LambdaCondition(std::function<bool(Ts...)> &&f)
    : f_(std::move(f)) {

}
template<typename... Ts>
bool LambdaCondition<Ts...>::check(Ts... x) {
  return this->f_(x...);
}
...
template<typename... Ts>
bool ActionList<Ts...>::empty() const {
...
template<typename... Ts>
UpdateComponentAction<Ts...>::UpdateComponentAction(PollingComponent *component)
    : component_(component) {

}

template<typename... Ts>
ScriptExecuteAction<Ts...>::ScriptExecuteAction(Script *script)
    : script_(script) {
...
template<typename... Ts>
ScriptStopAction<Ts...>::ScriptStopAction(Script *script)
    : script_(script) {
...
template<typename... Ts>
WaitUntilAction<Ts...>::WaitUntilAction(const std::vector<Condition<Ts...> *> &conditions)
  : conditions_(conditions) {
